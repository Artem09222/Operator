function Selected() {
  let selecte = document.querySelector(".disabled");
  let p = document.querySelector(".p");
  let s = selecte.options[selecte.selectedIndex].value;

  switch (s) {
    case "Coffee":
      p.textContent = "You buy a coffee";
      break;
    case "Tea":
      p.textContent = "You drink a tea";
      break;
    case "Juce":
      p.textContent = "You prepare juce";
  }
}
